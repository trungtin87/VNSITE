...
def doc_cau_hinh(duong_dan_goc: str) -> dict:
    ...
    cau_hinh.setdefault("so_bai_moi_trang", 10)
    ...
    # Mẫu permalink (giống "permalink:" của Jekyll) — đổi cấu trúc URL chỉ cần sửa ở đây,
    # không phải sửa rải rác trong builder.py nữa.
    cau_hinh.setdefault("permalink_bai_viet", "/:chuyen_muc/:nam/:thang/:slug/")
    cau_hinh.setdefault("permalink_du_an", "/du-an/:slug/")
    cau_hinh.setdefault("permalink_tag", "/tag/:slug/")
    return cau_hinh
